<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="universities.aspx.cs" Inherits="canadaproject.universities" %>
...
<body>
  ...
  <section class="container">
    <div class="page-header">
        <h1>لیست دانشگاه های کانادا جهت پذیرش<br/>
    ...
    <div class="row active-with-click">
            ...
            <article class="material-card Red">
                ...
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="images/Memoriallogo.png"/>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Pink">
                ...
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="images/BritishColumbiaLogo.png"/>
                    </div>
                    <div class="mc-description">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            <article class="material-card Purple">
                <h2>
                    <span>University of Torento</span>
                    <strong>
                        <i class="fa fa-fw fa-star"></i>
                        	Toronto, Ontario
                    </strong>
                ...
                <div class="mc-content">
                    <div class="img-container">
                        <img class="img-responsive" src="images/TorentoLogo.png"/>
                    </div>
                    <div class="mc-description">
